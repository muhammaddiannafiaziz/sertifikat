...
@section('title', 'Tambah Peserta Komputer Manual')

@section('content')
<div class="container mt-5">
    <h1 class="text-center mb-4">Tambah Peserta SKL Komputer</h1>
    ...
    <form action="{{ route('peserta-tipd.store') }}" method="POST" class="card shadow-sm p-4" style="max-width: 500px; margin: auto;">
        @csrf
        ...
        <div class="d-flex justify-content-between">
            <a href="{{ route('peserta-tipd.index') }}" class="btn btn-secondary">
