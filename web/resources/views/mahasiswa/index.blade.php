...
<div class="container p-3">
    <h4 class="fw-semibold">Daftar Mahasiswa</h4>

    <!-- Form Pencarian Mahasiswa, geser ke kiri dengan ikon pencarian -->
    <form action="{{ route('mahasiswa.index') }}" method="GET" class="d-flex py-2 align-items-center" style="flex-grow: 1; justify-content: flex-start; gap: 5px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3" style="font-size: 0.9rem;">
        ...
        <button type="button" class="btn btn-primary btn-sm d-flex align-items-center" style="font-size: 12px;" data-bs-toggle="modal" data-bs-target="#tambahMahasiswaModal" style="margin-right: 5px;">
            Tambah
            <i class="bi bi-plus-circle ms-2"></i> <!-- Ikon di sebelah kanan tombol Tambah -->
        </button>

        <!-- Tombol Import Mahasiswa dengan Modal -->
        <button type="button" class="btn btn-success btn-sm d-flex align-items-center" style="font-size: 12px;" data-bs-toggle="modal" data-bs-target="#importModal" style="margin-right: 5px;">
            Import
