...
@section('title', 'Tambah Peserta Bahasa Manual')

@section('content')
<div class="container mt-5">
    <h1 class="text-center mb-4">Tambah Peserta SKL Bahasa</h1>
    ...
    <form action="{{ route('peserta-bahasa.store') }}" method="POST" class="card shadow-sm p-4" style="max-width: 500px; margin: auto;">
        @csrf
        ...
        <div class="d-flex justify-content-between">
            <a href="{{ route('peserta-bahasa.index') }}" class="btn btn-secondary">
