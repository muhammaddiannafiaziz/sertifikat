...
@section('title', 'Daftar Peserta SKL Bahasa')

@section('content')
<div class="container p-3">
    <h4 class="fw-semibold">Daftar Peserta SKL Bahasa</h4>
    <p>Data Mahasiswa yang berhak dibuatkan SKL Bahasa Arab & Bahasa Inggris.</p>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <form action="{{ route('peserta-bahasa.index') }}" method="GET" class="d-flex align-items-center" style="gap: 5px;">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('peserta-bahasa.create') }}" class="btn btn-primary btn-sm" style="font-size: 12px;">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('peserta-bahasa.destroy', $data->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Menghapus peserta ini juga akan menghapus data SKL yang mungkin sudah terbit. Yakin?')">
                            @csrf
                            @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="6" class="text-center">Data Peserta SKL Bahasa tidak ditemukan.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importModalLabel">Import Peserta SKL Bahasa</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('peserta-bahasa.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
